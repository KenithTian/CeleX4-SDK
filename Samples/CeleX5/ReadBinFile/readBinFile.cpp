...
#define BIN_FILE	"C:/Users/whc/Desktop/API/CeleX5_Release/MipiData_20181108_204217049_E_100M.bin"	//your bin file path
...
int main()
{
	...
	pCeleX->openBinFile(BIN_FILE);	//open the bin file

...
bool CeleX4::readPlayBackData(long length)
{
	...
	while (true && m_pDataProcessThread->queueSize() < 1000000)
	{
		...
		{
			eof = true;
			m_pDataProcessThread->setPlaybackState(CeleX4::BinReadFinished);
			//m_ifstreamPlayback.close();
...
CeleX4::PlaybackState CeleX4::getPlaybackState()
{
	return m_pDataProcessThread->getPlaybackState();
}

void CeleX4::setPlaybackState(CeleX4::PlaybackState state)
{
